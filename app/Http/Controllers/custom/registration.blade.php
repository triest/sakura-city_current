    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <p>
                ...
                "Условия использования"), до осуществления регистрации на Сайте. Осуществление Вами регистрации на Сайте
            ...
            <p>
                2. Владелец Сайта - лицо (лица), имеющие соответствующие права на сетевой адрес, по которому находится
                Сайт.
            </p>
            <p>
                3. Администрация Сайта - лицо (лица), уполномоченные Владельцем Сайта на обеспечение деятельности Сайта,
            ...
            <p>
                4. Пользователь Сайта - дееспособное физическое лицо, достигшее 18 лет, использующее Сайт в соответствии
            ...
            <p>
                ...
                Пользователя Сайту, служащая для идентификации Пользователя и отождествления лица, использующего Сайт, с
            ...
            <p>
                На Сайте могут быть материалы, наличие и содержание которых, возможно, вызовет у Пользователя возражения
                морального (этического) плана. Используя Сайт, Пользователь подтверждает, что осознает вероятность этого
                и допускает возможность наличия на Сайте материалов (текстов, фотографий и т.п.), не согласующихся с его
            ...
            <p>
                Размещенные Пользователями на Сайте материалы и информация, содержащая мнения, предположения и оценочные
                суждения, являются исключительно мнениями, предположениями и оценочные суждениями данных Пользователей.
            </p>
            <p>
            ...
            <p>
                Кроме информации, размещенной Пользователями с соблюдением настоящих Условий использования на Сайте в
                разделе «Информация пользователя», вся информация и иные результаты интеллектуальной деятельности, в том
                числе (но не ограничиваясь) тексты, графика, фотографии, товарные знаки и знаки обслуживания,
                музыкальные и аудиовизуальные произведения, программы для ЭВМ, дизайн являются собственностью владельца
                Сайта.
            </p>
            <p>
                Ни в каком случае, кроме как по письменному разрешению Администрации Сайта, Пользователь не получает
                право на использование фирменного наименования, товарного знака, доменного имени и иных отличительных
                признаков Сайта. Администрации Сайта, Владельцев Сайта
            </p>
            <p>
                За исключением случаев, предусмотренных действующим законодательством Российской Федерации и настоящими
                Условиями использования, никакая информация и содержимое Сайта не может быть скопирована
                (воспроизведена), переработана, распространена, отображена, опубликована, сохранена, передана, продана
                или иным способом использована как целиком, так и по частям, без предварительного разрешения
                правообладателя, кроме случаев, когда правообладатель явным образом выразил свое согласие на указанные
            ...
            <p>
                ...
                Администрацией и Владельцами Сайта, как совершенные данным Пользователем. Бремя доказательства обратного
                лежит на Пользователе.
            </p>
            <p>
                Все сообщения, отправленные Администрацией Сайта, Владельцами Сайта и Пользователями, предназначаются
            ...
            <p>
                - самостоятельно, с соблюдением настоящих Условий использования, создавать, использовать и определять
            ...
            <p>
                - сохранять отдельные элементы Сайта (страницы) для просмотра на компьютере исключительно для личного
            ...
            <p>
                ...
                обязуется самостоятельно оценивать содержание размещаемых на Сайте Пользователем информации и материалов
                на соответствие требованиям действующего законодательства Российской Федерации
            </p>
            <p>
                - руководствоваться общепринятыми нормами общения в отношении других Пользователей Сайта. В том случае,
                если какой-либо Пользователь Сайта не желает поддерживать общение с тем или иным Пользователем, о чем
            ...
            <p>
                ...
                осуществления любых видов политической, религиозной, национальной и иной пропаганды, как прямо, так и
                косвенно.
            </p>
            <p>
            ...
            <p>
                - не размещать на Сайте информацию, к которой предусмотрен ограниченный доступ, в том числе информацию,
            ...
            <p>
                - получить предварительное письменное согласие Администрации Сайта на передачу своего права пользования
            ...
            <p>
                ...
                Пользователей) к закрытым идентифицирующим данным Пользователя, он обязан немедленно поставить об этом в
                известность Администрацию Сайта с использованием существующей на сайте формы связи с Администрацией
                Сайта;
            </p>
            <p>
                - не совершать действий, имеющих целью получение доступа к закрытой идентификационной информации другого
                Пользователя;
            </p>
            <p>
            ...
            <p>
                - не размещать высказывания и (или) информацию, пропагандирующие преступную деятельность или содержащие
                советы и (или) руководства по совершению преступных действий;
            </p>
            <p>
                - не загружать, не хранить, не публиковать, не распространять и не предоставлять доступ или иным образом
                не использовать, а равно не способствовать использованию вредоносного программного обеспечения, серийных
            ...
            <p>
                - не размещать информацию, распространение которой запрещено законодательством Российской Федерации, в
                том числе информацию, содержащую призывы о насильственном изменении конституционного строя, разжигании
                расовой, национальной, религиозной розни, совершении экстремистских действий, дискриминации по расовым,
            ...
            <p>
                ...
                разрешения. Администрация Сайта вправе запросить у Пользователя документы, подтверждающие наличие такого
                разрешения.
            </p>
            <p>
                ...
                (копирайтов) или других уведомлений об авторстве, сохранения имени автора в неизменном виде, сохранении
            ...
            <p>
                - не размещать фотографии интимного содержания в открытом доступе. Данные фотографии следует размещать в
            ...
            <p>
                ...
                соответствующей целям создания и функционирования Сайта, ущемляющей права и интересы иных Пользователей,
            ...
            <p>
                - изменять, модифицировать, добавлять или удалять положения Условий использования, размещенных по адресу
                sakura-city.info/rules, в любое время, но не чаще, чем один раз в сутки (по времени Сайта). Продолжение
                использования Сайта Пользователем после внесения изменений означает, что Пользователь согласен с этими
                изменениями.
            </p>
            <p>
            ...
            <p>
                - в случае нарушения Пользователем любого из положений настоящих Условий использования в одностороннем
            ...
            <p>
                - редактировать или удалять любые материалы на сайте, не соответствующие Условиям использования, или,
            ...
            <p>
                - сообщать в соответствии с действующим законодательством о деятельности отдельных Пользователей и (или)
                размещенных ими материалах, нарушающих законодательство Российской Федерации, в соответствующие
                компетентные органы. При этом Администрация Сайта имеет право предоставить всю известную ей информацию о
            ...
            <p>
                ...
                Пользователей (отправлять Пользователю рекламные сообщения, сообщения от службы поддержки Сайта, и от
                других пользователей).
            </p>
            <p>
                - создавать в автоматическом режиме сообщения, приглашения, поздравления, напоминания для целей
                информирования или развлечения. Используя Сайт, Пользователь выражает свое согласие на получение таких
                сообщений, приглашений, поздравлений, напоминаний.
            </p>
            <p>
                - периодически размещать информацию о товарах, услугах и иных предложениях третьих лиц, в том числе в
                ...
                Администрация Сайта имеет какое-либо отношение к лицам, упоминаемым в данной информации. Администрация
                ...
                ответственность, которые Пользователь может понести, используя данную информацию, в том числе вступая в
            ...
            <p>
                ...
                подразумеваемые обещания, гарантии от имени Администрации и (или) Владельцев Сайта не могут быть даны и
                подразумеваемы.
            </p>
            <p>
                Администрация и Владельцы Сайта не могут гарантировать, что работа Сайта постоянно будет непрерывной,
                бесперебойной и корректной. Администрация Сайта не несет ответственности за временные сбои и перерывы в
            ...
            <p>
                ...
                проистекающие из несовместимости используемого Пользователем программного и аппаратного обеспечения с
            ...
            <p>
                ...
                которых Пользователь уведомлял Администрацию и (или) Владельцев Сайта в том числе, в случаях: наличия
                неточной информации на Сайте, перерывами и задержками в функционировании Сайта, нарушением любым лицом
                любых прав на объекты интеллектуальной собственности и авторского права третьих лиц, связанным с
                использованием Сайта, любыми убытками, причиненными воздействием вредоносного программного обеспечения,
                ...
                Интернет, ссылки на которые были размещены на Сайте, а также любым взаимодействием с данными сайтами.
            ...
            <p>
                Администрация и Владельцы Сайта не несут ответственности за любые убытки, материальный и моральный вред,
                потерю информации или любой другой ущерб, в том числе в случае, если возможно было предвидеть, что это
                происходит во время использования Сайта.
            </p>
            <p>
                Пользователь использует Сайт исключительно на свой риск. Известный риск использования сети «Интернет»
                состоит в том, что люди могут быть не теми, за кого себя выдают, предоставлять недостоверную, ненадежную
            ...
            <p>
                ...
                размещаемых Пользователями, и не несет ответственности за подлинность и достоверность такой информации и
                материалов.
            </p>
            <p>
                Администрация Сайта не имеет возможности проверять правдивость утверждений Пользователей, а также
                гарантировать применимость размещенных анкет к тому или иному Пользователю и соответствие содержащейся в
                анкете информации реальности. В вопросах общения только каждый Пользователь может принимать решения по
            ...
            <p>
                ...
                случае предъявления к Администрации Сайта и (или) Владельцам Сайта претензий со стороны третьих лиц и
            ...
            <p>
                ...
                требований, исков относительно нарушения законодательства об авторском праве в отношении материалов и
                (или) информации, размещенных Пользователем, Пользователь обязуется самостоятельно предпринять все меры
            ...
            <p>
                Настоящие Условия использования становятся обязательными для Пользователя с момента его регистрации на
                Сайте и действуют в течение неопределенного срока.
            </p>
            <p>
                Настоящие Условия использования регулируются и толкуются в соответствии с действующим законодательством
                Российской Федерации.
            </p>
            <p>
            ...
            <p>
                Администрация и Владельцы Сайта имеют право прекратить доступ к Сайту в случае нарушения Пользователем
            ...
            <p>
                ...
                использования, Пользователь и Администрация Сайта приложат все усилия для их разрешения путем проведения
                переговоров. В случае, если спор или разногласие не будут разрешены путем переговоров в течение 90 дней
